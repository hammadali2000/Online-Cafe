	...
	<header>
		<nav>
			...
			<div class="second-content">
				<table class="t2">
					<tr>
				<td><img src="images/fajita.jpg" class="img" style="margin:0px 50px"><br><p class="font">Chicken Fajita Pizza</p><br><p class="p1">RS 600</p> </td>
				<td><img src="images/afghani.jpg" class="img" style="margin:0px 50px"><br><p class="font">Afghani Pizza</p><br> <p class="p2">RS 560</p>  </td> 
				<td><img src="images/italian.jpg" class="img" style="margin:0px 50px"><br><p class="font">Italian</p>  <br> <p class="p3">RS 800</p>  </td> <br>
				</tr>
				</table>
			</div>
	</header>
