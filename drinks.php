	...
	<header>
		<nav>
			...
			<div class="second-content">
				<table class="t2">
					<tr>
				<td><img src="images/sprite.jpg" class="img" style="margin:0px 50px"><br><p class="font">Spritet</p><br><p class="p1">RS 90</p> </td>
				<td><img src="images/coke.jpg" class="img" style="margin:0px 50px"><br><p class="font">Coke</p><br> <p class="p2">RS 90</p>  </td> 
				<td><img src="images/fanta.jpg" class="img" style="margin:0px 50px"><br><p class="font">Fanta</p>  <br> <p class="p3">RS 90</p>  </td> <br>
				</tr>
				</table>
			</div>
	</header>
