	...
	<header>
		<nav>
			...
			<div class="second-content">
				<table class="t2">
					<tr>
				<td><img src="images/doodh.jpg" class="img" style="margin:0px 50px"><br><p class="font">Doodh Patti</p><br><p class="p1">RS 110</p> </td>
				<td><img src="images/green.jpg" class="img" style="margin:0px 50px"><br><p class="font">Green Tea</p><br> <p class="p2">RS 130</p>  </td> 
				<td><img src="images/espresso.jpg" class="img" style="margin:0px 50px"><br><p class="font">Espresso Coffe</p>  <br> <p class="p3">RS 170</p>  </td> <br>
				</tr>
				</table>
			</div>
	</header>
