...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Css/parathas.css">
	...
	<header>
		<nav>
			...
			<div class="second-content">
				<table class="t2">
					<tr>
				<td><img src="images/nutella.jpg" class="img" style="margin:0px 50px"><br><p class="font">Nutella Paratha</p><br><p class="p1">RS 230</p> </td>
				<td><img src="images/Egg.jpg" class="img" style="margin:0px 50px"><br><p class="font">Egg Paratha</p><br> <p class="p2">RS 100</p>  </td> 
				<td><img src="images/potato.jpg" class="img" style="margin:0px 50px"><br><p class="font">Caramel Tart</p>  <br> <p class="p3">RS 180</p>  </td> <br>
				</tr>
				</table>
			</div>
	</header>
